...
/* Single text color used everywhere on light backgrounds */
...
const inputBase: React.CSSProperties = {
  ...
  fontSize: '14px',
  color: TEXT_DARK, background: '#f8faff',
  outline: 'none', boxShadow: 'none',
  appearance: 'none' as const, WebkitAppearance: 'none' as const,
  boxSizing: 'border-box' as const,
};
const labelStyle: React.CSSProperties = {
  display: 'block', fontSize: '11px', fontWeight: 600, color: TEXT_DARK,
...
export default function SignupPage() {
  ...
  const fi = (n: string): React.CSSProperties => ({
    ...inputBase,
    borderColor: focused === n ? TEXT_DARK : '#e2e8f0',
  ...
  return (
    ...
    >
      <style jsx global>{`
        /* Modern Geometric Sans-Serif — FORCED on every element */
        .auth-page,
        .auth-page *,
        .auth-page h1, .auth-page h2, .auth-page h3, .auth-page h4,
        .auth-page h5, .auth-page h6,
        .auth-page p, .auth-page span, .auth-page a, .auth-page button,
        .auth-page strong, .auth-page small, .auth-page em, .auth-page b,
        .auth-page div, .auth-page label, .auth-page input, .auth-page select,
        .auth-page textarea {
        ...
        /* CHANGED: same color for every text element on light backgrounds */
        .auth-page,
        .auth-page h1, .auth-page h2, .auth-page h3, .auth-page h4,
        .auth-page h5, .auth-page h6,
        .auth-page p, .auth-page span, .auth-page a, .auth-page button,
        .auth-page strong, .auth-page small, .auth-page em, .auth-page b,
        .auth-page div, .auth-page label {
          color: ${TEXT_DARK} !important;
        }

        /* CHANGED: every button inside this page is pill-shaped */
        .auth-page button,
        .auth-page a.auth-pill {
          border-radius: 9999px !important;
        }

        @media (max-width: 900px) {
          .auth-panel-left { display: none !important; }
          .auth-panel-right { width: 100% !important; }
      ...
      >
        <div style={{ position: 'absolute', top: -160, right: -160, width: 400, height: 400, borderRadius: '50%', background: 'rgba(255,255,255,0.05)', pointerEvents: 'none' }} />
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingBottom: '40px' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '20px' }}>
            <div style={{ width: '20px', height: '3px', borderRadius: 999, background: '#ffffff', opacity: 0.5 }} />
            <span style={{ fontSize: '11px', fontWeight: 700, color: '#ffffff', letterSpacing: '0.8px', textTransform: 'uppercase' }}>Free to Join</span>
          </div>
          <h1 style={{ fontSize: 'clamp(1.6rem,2.5vw,2.4rem)', fontWeight: 900, color: '#ffffff', lineHeight: 1.12, letterSpacing: '-0.8px', marginBottom: '14px' }}>
            Start your career<br />transformation today.
          </h1>
          <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.75, marginBottom: '36px', maxWidth: '320px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '11px' }}>
            {['Zero upfront cost — pay after placement', 'Direct connect to 50+ hiring partners', 'Resume rebuild + 3 mock interviews', 'Dedicated advisor throughout your journey'].map(p => (
              <div key={p} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                <CheckCircle2 size={15} color="#ffffff" strokeWidth={2.5} style={{ flexShrink: 0, marginTop: '2px' }} />
                <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.5 }}>{p}</span>
              </div>
            ))}
          </div>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', borderTop: '1px solid rgba(255,255,255,0.10)', paddingTop: '24px', gap: '12px' }}>
          {[{ n: '9 days', l: 'Fastest Placed' }, { n: '40%+', l: 'Avg Salary Hike' }, { n: '50+', l: 'Hiring Partners' }].map(s => (
            <div key={s.n} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '17px', fontWeight: 900, color: '#ffffff' }}>{s.n}</div>
              <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', marginTop: '3px' }}>{s.l}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div
        ...
        style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px', background: '#fff', overflowY: 'auto' }}
      >
        <div style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 900, letterSpacing: '-0.5px', marginBottom: '6px' }}>Create your account</h2>
            <p style={{ fontSize: '14px', color: '#64748b' }}>
              Already have one?{' '}
              {/* CHANGED: link color → black, no blue accent */}
              <Link href="/login" style={{ fontWeight: 600, textDecoration: 'none' }}>Sign in →</Link>
            </p>
          </div>
          ...
          <button
            ...
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', width: '100%', padding: '12px', border: '1.5px solid #e2e8f0', borderRadius: '10px', fontSize: '14px', fontWeight: 600, color: TEXT_DARK, background: '#fff', cursor: 'pointer', marginBottom: '20px' }}
          >
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div className="auth-name-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <div style={{ position: 'absolute', left: 13, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}><User size={14} color={focused === 'first' ? TEXT_DARK : '#cbd5e1'} /></div>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <div style={{ position: 'absolute', left: 13, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}><User size={14} color={focused === 'last' ? TEXT_DARK : '#cbd5e1'} /></div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <div style={{ position: 'absolute', left: 13, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}><Mail size={14} color={focused === 'email' ? TEXT_DARK : '#cbd5e1'} /></div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <div style={{ position: 'absolute', left: 13, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}><Phone size={14} color={focused === 'phone' ? TEXT_DARK : '#cbd5e1'} /></div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <div style={{ position: 'absolute', left: 13, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}><Briefcase size={14} color={focused === 'service' ? TEXT_DARK : '#cbd5e1'} /></div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <div style={{ position: 'absolute', left: 13, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}><Lock size={14} color={focused === 'pass' ? TEXT_DARK : '#cbd5e1'} /></div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '10px', padding: '11px 13px' }}>
              <CheckCircle2 size={15} color="#0b0d20" style={{ flexShrink: 0, marginTop: '1px' }} />
            ...
            {/* CHANGED: pill-shaped submit button (was 10px, now 9999px) + plain black background */}
            <button
              type="submit"
              disabled={loading}
              style={{
                width: '100%', padding: '14px',
                background: loading ? '#94a3b8' : '#0b0d20',
