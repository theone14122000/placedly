    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff7ed', fontFamily: "'Poppins',sans-serif", padding: '24px' }}>
      <div style={{ maxWidth: '440px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="mailto:admin@placedly.in" style={{ padding: '12px 24px', background: '#f97316', color: '#fff', borderRadius: '9999px', fontWeight: 700, fontSize: '14px', textDecoration: 'none' }}>
            Email Admin →
          </a>
          <Link href="/" style={{ padding: '12px 24px', background: '#fff', color: '#374151', border: '1.5px solid #e2e8f0', borderRadius: '9999px', fontWeight: 600, fontSize: '14px', textDecoration: 'none' }}>
            Back to Home
          </Link>
        </div>
      </div>
