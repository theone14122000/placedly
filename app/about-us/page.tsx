...
/* Inline animated gradient — renders server-side, animates client-side via CSS */
    ...
    <>
      <Tag
        ...
        style={{
          ...
          backgroundClip: 'text',
          animation: 'ab-grad 7s ease infinite',
          display: 'inline',
          ...style,
        }}
      >
...
/* Accent pill / label used throughout */
function SectionLabel({ text }: { text: string }) {
  return (
    <div style={{
      ...
      <span style={{
        width: '22px', height: '3px', borderRadius: '999px',
...
export default async function AboutUsPage() {
  ...
  /* dot accent colours cycling per timeline step */
    ...
    <PageLayout>
      ...
      >
        ...
        <div aria-hidden style={{
          ...
          background: `radial-gradient(circle, ${G.orange}16 0%, transparent 70%)`,
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <nav style={{
            ...
            <a href="/" style={{ color: '#94a3b8', textDecoration: 'none', transition: 'color .2s' }}>Home</a>
          ...
          <div style={{ maxWidth: '780px' }}>
            ...
            <h1 style={{
              ...
              letterSpacing: '-1.5px', color: '#0b0d20',
              marginBottom: '24px',
            }}>
              We&apos;re Not Just a<br />
              Placement Agency.{' '}
              <GradientHeading tag="h1">
                We&apos;re Career Partners.
              </GradientHeading>
            </h1>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '64px' }}>
              <a href="/contact" style={{
                ...
                textDecoration: 'none',
                boxShadow: `0 8px 24px ${G.blue}35`,
      ...
      <section id="our-story" style={{ padding: '96px 0', background: '#fff' }}>
        <div className="container">
          <div className="ab-two-col" style={{
            ...
            <div>
              ...
              <h2 style={{
                ...
                fontWeight: 900, color: '#0b0d20',
                lineHeight: 1.12, letterSpacing: '-0.8px', marginBottom: '22px',
              }}>
                Making Career Growth{' '}
                <GradientHeading>Accessible</GradientHeading>
                {' '}for Everyone
              </h2>
              ...
              <a href="/contact" style={{
                ...
                textDecoration: 'none',
                boxShadow: `0 8px 22px ${G.blue}30`,
              }}>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            ...
            <h2 style={{
              ...
              The Principles That{' '}
              <GradientHeading>Drive Us</GradientHeading>
            </h2>
          </div>

          <div className="ab-values-3" style={{
            ...
            {values.map((v, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: '15.5px', fontWeight: 800, color: '#0f172a', marginBottom: '10px' }}>
                  {v.title}
                </div>
      ...
      {/* ════════════════════ TIMELINE ════════════════════ */}
      <section id="journey" style={{ padding: '96px 0', background: '#fff' }}>
        <div className="container">
          <div className="ab-two-col" style={{
            display: 'grid', gridTemplateColumns: '1fr 1fr',
            ...
            <div style={{ position: 'sticky', top: '100px' }}>
              ...
              <h2 style={{
                fontSize: 'clamp(1.9rem, 3vw, 2.75rem)',
                fontWeight: 900, color: '#0b0d20',
                lineHeight: 1.12, letterSpacing: '-0.8px', marginBottom: '18px',
              }}>
                From Startup to{' '}
                <GradientHeading>300+ Placements</GradientHeading>
              </h2>
              <p style={{ fontSize: '15.5px', color: '#64748b', lineHeight: 1.8, marginBottom: '32px' }}>
                Every milestone was earned the hard way — one candidate at a time,
                one employer relationship at a time.
              </p>
              {/* Progress illustration */}
              <div style={{
                background: '#f8faff', borderRadius: '16px',
                padding: '22px 24px',
                border: `1px solid ${G.blue}18`,
              }}>
                ...
                {[
                  ...
                  <div key={bar.label} style={{ marginBottom: '10px' }}>
                    ...
                    <div style={{ height: '6px', borderRadius: '99px', background: '#eef2ff', overflow: 'hidden' }}>
                      <div style={{
                        height: '100%', width: `${bar.val}%`, borderRadius: '99px',
                        background: `linear-gradient(90deg, ${G.blue}, ${G.orange})`,
                      }} />
                    </div>
                  </div>
                  ...
                  <div key={i} style={{ display: 'flex', gap: '20px', alignItems: 'stretch' }}>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        marginBottom: '4px', padding: '3px 10px',
                        borderRadius: '999px',
                        background: `${col}15`, color: col,
                      }}>
                        {item.year}
                      </div>
                      <div style={{ fontSize: '15.5px', fontWeight: 800, color: '#0f172a', marginBottom: '5px' }}>
                        {item.title}
                      </div>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '52px' }}>
            ...
            <h2 style={{
              ...
              The Person Behind{' '}
              <GradientHeading>Placedly</GradientHeading>
            </h2>
          </div>
          ...
          <div className="ab-founder-card" style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{
                fontSize: '24px', fontWeight: 900, color: '#0b0d20', marginBottom: '4px',
              }}>
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  fontSize: '48px', lineHeight: 1, color: G.blue, opacity: 0.15,
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{
                ...
                <span style={{
                  width: '22px', height: '2px', borderRadius: '999px',
                  background: `linear-gradient(90deg, ${G.blue}, ${G.orange})`,
                }} />
                Take Action
              </div>
              ...
              <p style={{
                fontSize: '15.5px', color: 'rgba(255,255,255,.55)',
              ...
              <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
                ...
                <a href="/study-visa" style={{
                  ...
                  padding: '15px 34px', borderRadius: '999px',
                  textDecoration: 'none',
                  boxShadow: `0 8px 28px ${G.orange}40`,
                }}>
      ...
      <style>{`
        ...
        @media (max-width: 580px) {
          ...
          .page-dark-cta { padding: 48px 24px !important; }
        }
      `}</style>
